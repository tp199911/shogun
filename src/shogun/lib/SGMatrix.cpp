...
{
	SGMatrix<int8_t> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : 0.0;
	}
...
{
	SGMatrix<uint8_t> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : 0.0;
...
{
	SGMatrix<bool> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : (!scale);
	}
...
{
	SGMatrix<int16_t> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : 0.0;
...
{
	SGMatrix<uint16_t> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : 0.0;
...
{
	SGMatrix<int32_t> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : 0.0;
...
{
	SGMatrix<uint32_t> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : 0.0;
...
{
	SGMatrix<int64_t> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : 0.0;
...
{
	SGMatrix<uint64_t> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : 0.0;
...
{
	SGMatrix<float32_t> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : 0.0;
...
{
	SGMatrix<float64_t> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : 0.0;
...
{
	SGMatrix<floatmax_t> identity(size, size);
	for (index_t i=0; i<size; ++i)
	{
		for (index_t j=0; j<size; ++j)
			identity(i,j)=i==j ? scale : 0.0;
